...
import com.sbk.kaizenInd.exception.ProductNotFoundException;
//import com.sbk.kaizenInd.exception.ProductNotFoundException;
...
public class PageController {
	...
	@RequestMapping(value = {"/machining"})
	public ModelAndView machining(){
		ModelAndView mv = new ModelAndView("page");
		mv.addObject("title", "Machining");
		mv.addObject("userClickMachining", true);
		return mv;
	}
